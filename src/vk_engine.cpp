...
void VulkanEngine::draw_background(VkCommandBuffer cmd) {
    ...
    vkCmdPushConstants(cmd, _gradientPipelineLayout,
...
void VulkanEngine::draw_imgui(VkCommandBuffer cmd,
    ...
    VkRenderingAttachmentInfo colorAttch = vkinit::attachment_info(
            targetImageView, nullptr, VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL);
    VkRenderingInfo renderInfo =
            vkinit::rendering_info(_swapchainExtent, &colorAttch, nullptr);
...
AllocatedBuffer VulkanEngine::create_buffer(size_t allocSize,
    ...
    VK_CHECK(vmaCreateBuffer(_allocator, &bufferInfo, &vmaallocinfo,
                             &newBuf.buffer, &newBuf.allocation, &newBuf.info));
    return newBuf;
}
...
void VulkanEngine::init_vulkan() {
    ...
    vk12features.bufferDeviceAddress =
            true;// Allows for use of GPU pointers w/o binding buffers
...
void VulkanEngine::init_swapchain() {
    ...
    VkImageViewCreateInfo dview_info = vkinit::imageview_create_info(
            _depthImage.imageFormat, _depthImage.image,
...
void VulkanEngine::init_mesh_pipeline() {
    ...
    if (!vkutil::load_shader_module("../shaders/colored_triangle_mesh.vert.spv",
        ...
        fmt::println(
                "[Mesh] Error when building the triangle vertex shader module");
    } else {
